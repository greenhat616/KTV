...
public class JdbcHelper {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static List query(String sql, Object... parameters) throws SQLException {
	 ...
	 * @throws SQLException
	 */
	public static Object insertWithReturnPrimeKey(String sql, Object... parameters) throws SQLException {
		ResultSet rs = null;
		Object result = null;
		try {
			conn = JdbcUnits.getConnection();
	 ...
	 * @throws SQLException
	 */
	public static Object callableGetSingle(String procedureSql, Object... parameters) throws SQLException {
		Object result = null;
		ResultSet rs = null;
		try {
			getCallableStatement(procedureSql);
